...
export class ProfileListComponent implements OnInit {
  ...
  enableEdit(profile: Profile) {
    console.log('Enabling edit for profile:', profile);
  ...
  updateProfile() {
    console.log('Updating profile:', this.editNickname, this.editNombre, this.editApellido, this.editCodigoSituacionSentimental, this.editEquipoActual);
